...
import static com.driverInstance.DriverInstance.setPlatform;
...
public class Drivertools {
	...
	public Drivertools(String application,String deviceName,String portno) {
		...
		setBundleId(getHandler().getproperty(application + "BundleId"));
	...
	{
		setPlatfrom(Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("Platform"));
		...
		setViewType(Reporter.getCurrentTestResult().getTestContext().getCurrentXmlTest().getParameter("viewType"));
